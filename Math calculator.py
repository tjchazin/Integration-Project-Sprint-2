...
def main():
    ...
    given from the user. It then calls the hypotenuse function with the 
    arguments of a and b. Another try except in case the user doesn't 
    input an integer.'''
        ...
        # the user for 5 numbers, and will output the sum of those 5 numbers.
        elif user_input == 6:
            num_amount = 0
            sum_of_numbers = 0
